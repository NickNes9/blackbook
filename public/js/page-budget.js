  ...
  budgetCardsHtml() {
    ...
    for (const cat of allRows) {
      ...
      html += '<div class="budget-card">' +
        ...
        '</span>' +
        '<span class="bar-values-wrap"><div class="budget-bar' + (budget ? '' : ' budget-bar-none') + '" style="background:' + barBg + ';"><div class="budget-bar-fill' + (budget ? '' : ' budget-bar-fill-full') + ' ' + (over ? 'over' : '') + '" style="width:' + fillPct + '%;background:' + catColor + (over ? ';opacity:0.9' : '') + ';"><span class="budget-bar-values-filled' + (over ? ' amount-negative' : '') + '">' + barValues + '</span></div><span class="budget-bar-values-unfilled' + (over ? ' amount-negative' : '') + '" style="left:' + fillPct + '%;">' + barValues + '</span></div></span>' +
